...
const (
	UnmountReason_Exit      UnmountReason = 0 // plugin exit
	UnmountReason_NotUsed   UnmountReason = 1 // plugin not used
	UnmountReason_Upgrade   UnmountReason = 2 // plugin upgrade
	UnmountReason_Downgrade UnmountReason = 3 // plugin downgrade
	UnmountReason_Panic     UnmountReason = 4 // plugin panic
)

// Enum value maps for UnmountReason.
var (
	UnmountReason_name = map[int32]string{
		0: "Exit",
		1: "NotUsed",
		2: "Upgrade",
		3: "Downgrade",
	...
	UnmountReason_value = map[string]int32{
		"Exit":      0,
		"NotUsed":   1,
		"Upgrade":   2,
		"Downgrade": 3,
...
func (x UnmountReason) Enum() *UnmountReason {
	p := new(UnmountReason)
	*p = x
	return p
}

func (x UnmountReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UnmountReason) Descriptor() protoreflect.EnumDescriptor {
	return file_conn_proto_enumTypes[0].Descriptor()
}

func (UnmountReason) Type() protoreflect.EnumType {
	return &file_conn_proto_enumTypes[0]
}

func (x UnmountReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UnmountReason.Descriptor instead.
func (UnmountReason) EnumDescriptor() ([]byte, []int) {
...
const (
	CommunicateType_Mount        CommunicateType = 0 // mount
	CommunicateType_Unmount      CommunicateType = 1 // unmount
	CommunicateType_ExecRequest  CommunicateType = 2 // core: exec request
	CommunicateType_ExecResponse CommunicateType = 3 // core: exec response
	CommunicateType_Ping         CommunicateType = 4 // plugin: keep alive
	CommunicateType_Log          CommunicateType = 5 // plugin: log
)
...
type MountRequest struct {
	...
	Token     string   `protobuf:"bytes,1,opt,name=Token,proto3" json:"Token,omitempty"`         // mount token
	...
	Functions []string `protobuf:"bytes,4,rep,name=Functions,proto3" json:"Functions,omitempty"` // functions list
}
...
func (x *MountRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *MountRequest) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *MountRequest) GetFunctions() []string {
	if x != nil {
		return x.Functions
	}
	return nil
...
type UnmountRequest struct {
	...
	Reason  UnmountReason `protobuf:"varint,1,opt,name=Reason,proto3,enum=pb.UnmountReason" json:"Reason,omitempty"` // unmount reason
	Token   string        `protobuf:"bytes,2,opt,name=Token,proto3" json:"Token,omitempty"`                          // mount token
	Name    string        `protobuf:"bytes,3,opt,name=Name,proto3" json:"Name,omitempty"`                            // plugin name
	Version string        `protobuf:"bytes,4,opt,name=Version,proto3" json:"Version,omitempty"`                      // plugin version
	Msg     *string       `protobuf:"bytes,5,opt,name=Msg,proto3,oneof" json:"Msg,omitempty"`                        // unmount message
}
...
func (x *UnmountRequest) GetReason() UnmountReason {
	if x != nil {
		return x.Reason
	}
	return UnmountReason_Exit
}

func (x *UnmountRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *UnmountRequest) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *UnmountRequest) GetMsg() string {
	if x != nil && x.Msg != nil {
		return *x.Msg
	}
	return ""
...
type CommunicateMsg struct {
	...
	Data []byte          `protobuf:"bytes,2,opt,name=Data,proto3" json:"Data,omitempty"` // communicate payload
}
...
type CommunicateExecRequest struct {
	...
	ID       uint64    `protobuf:"varint,1,opt,name=ID,proto3" json:"ID,omitempty"`                       // exec id
	FuncName string    `protobuf:"bytes,2,opt,name=FuncName,proto3" json:"FuncName,omitempty"`            // func name
	Type     CodecType `protobuf:"varint,3,opt,name=Type,proto3,enum=pb.CodecType" json:"Type,omitempty"` // codec type
	Args     []byte    `protobuf:"bytes,4,opt,name=Args,proto3" json:"Args,omitempty"`                    // func args
}
...
type CommunicateExecResponse struct {
	...
	ID     uint64    `protobuf:"varint,1,opt,name=ID,proto3" json:"ID,omitempty"`                       // exec id
	Type   CodecType `protobuf:"varint,2,opt,name=Type,proto3,enum=pb.CodecType" json:"Type,omitempty"` // codec type
	Result []byte    `protobuf:"bytes,3,opt,name=Result,proto3" json:"Result,omitempty"`                // func result
	Err    *string   `protobuf:"bytes,4,opt,name=Err,proto3,oneof" json:"Err,omitempty"`                // error
}
...
var file_conn_proto_rawDesc = []byte{
	...
	0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x70, 0x0a, 0x0c, 0x4d, 0x6f, 0x75,
	0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x54, 0x6f, 0x6b,
	...
	0x09, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x09, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x9e, 0x01, 0x0a, 0x0e,
	0x55, 0x6e, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29,
	0x0a, 0x06, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11,
	0x2e, 0x70, 0x62, 0x2e, 0x55, 0x6e, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x61, 0x73, 0x6f,
	0x6e, 0x52, 0x06, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x54, 0x6f, 0x6b,
	...
	,
	...
	,
	...
	,
...
var file_conn_proto_goTypes = []interface{}{
	(UnmountReason)(0),              // 0: pb.UnmountReason
	...
	(*MountRequest)(nil),            // 7: pb.MountRequest
	(*UnmountRequest)(nil),          // 8: pb.UnmountRequest
...
var file_conn_proto_depIdxs = []int32{
	0,  // 0: pb.UnmountRequest.Reason:type_name -> pb.UnmountReason
	...
	10, // 5: pb.Conn.Communicate:input_type -> pb.CommunicateMsg
	10, // 6: pb.Conn.Communicate:output_type -> pb.CommunicateMsg
...
func (c *connClient) Communicate(ctx context.Context, opts ...grpc.CallOption) (Conn_CommunicateClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Conn_serviceDesc.Streams[0], "/pb.Conn/Communicate", opts...)
	if err != nil {
		return nil, err
	}
